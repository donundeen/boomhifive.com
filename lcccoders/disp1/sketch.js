...
function daniellaDraw() {
  ...
  pop();
  push();
  arc(adjustedWidth*.25, adjustedHeight*.7, adjustedWidth*.3, adjustedHeight*.1, 0, 3.14); // Mouth
  fill(283,292,292);
  arc(adjustedWidth*.25, adjustedHeight*.7, adjustedWidth*.3, adjustedHeight*.1, 0, 3.14); // Smile (teeth)
  pop();
  fill(90,10,100);
